...
SET(CylinderRayCastingHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(CylinderRayCastingBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "CylinderRayCasting Source Directory: ${CylinderRayCastingHome}")
MESSAGE(STATUS "CylinderRayCasting Binary Directory: ${CylinderRayCastingBinaryDir}")

# include macros
INCLUDE(${CylinderRayCastingHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(CylinderRayCasting_MSVC2013 TRUE)
    SET(CylinderRayCasting_WIN32 TRUE)
...
LIST(APPEND CylinderRayCastingIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND CylinderRayCastingGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${CylinderRayCastingHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND CylinderRayCastingGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND CylinderRayCastingGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND CylinderRayCastingGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND CylinderRayCasting_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${CylinderRayCastingHome}/cmake")
