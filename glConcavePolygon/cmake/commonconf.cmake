...
SET(ConcavePolygonHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(ConcavePolygonBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "ConcavePolygon Source Directory: ${ConcavePolygonHome}")
MESSAGE(STATUS "ConcavePolygon Binary Directory: ${ConcavePolygonBinaryDir}")

# include macros
INCLUDE(${ConcavePolygonHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(ConcavePolygon_MSVC2013 TRUE)
    SET(ConcavePolygon_WIN32 TRUE)
...
LIST(APPEND ConcavePolygonIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND ConcavePolygonGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${ConcavePolygonHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND ConcavePolygonGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND ConcavePolygonGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND ConcavePolygonGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND ConcavePolygon_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${ConcavePolygonHome}/cmake")
