...
SET(SimpleStencilExampleHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(SimpleStencilExampleBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "SimpleStencilExample Source Directory: ${SimpleStencilExampleHome}")
MESSAGE(STATUS "SimpleStencilExample Binary Directory: ${SimpleStencilExampleBinaryDir}")

# include macros
INCLUDE(${SimpleStencilExampleHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(SimpleStencilExample_MSVC2013 TRUE)
    SET(SimpleStencilExample_WIN32 TRUE)
...
LIST(APPEND SimpleStencilExampleIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND SimpleStencilExampleGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${SimpleStencilExampleHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND SimpleStencilExampleGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND SimpleStencilExampleGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND SimpleStencilExampleGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND SimpleStencilExample_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${SimpleStencilExampleHome}/cmake")
