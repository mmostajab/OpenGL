...
SET(CylinderTesselationHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(CylinderTesselationBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "CylinderTesselation Source Directory: ${CylinderTesselationHome}")
MESSAGE(STATUS "CylinderTesselation Binary Directory: ${CylinderTesselationBinaryDir}")

# include macros
INCLUDE(${CylinderTesselationHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(CylinderTesselation_MSVC2013 TRUE)
    SET(CylinderTesselation_WIN32 TRUE)
...
LIST(APPEND CylinderTesselationIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND CylinderTesselationGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${CylinderTesselationHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND CylinderTesselationGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND CylinderTesselationGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND CylinderTesselationGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND CylinderTesselation_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${CylinderTesselationHome}/cmake")
