...
SET(PrimitiveComparisonHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(PrimitiveComparisonBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "PrimitiveComparison Source Directory: ${PrimitiveComparisonHome}")
MESSAGE(STATUS "PrimitiveComparison Binary Directory: ${PrimitiveComparisonBinaryDir}")

# include macros
INCLUDE(${PrimitiveComparisonHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(PrimitiveComparison_MSVC2013 TRUE)
    SET(PrimitiveComparison_WIN32 TRUE)
...
LIST(APPEND PrimitiveComparisonIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND PrimitiveComparisonGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${PrimitiveComparisonHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND PrimitiveComparisonGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND PrimitiveComparisonGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND PrimitiveComparisonGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND PrimitiveComparison_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${PrimitiveComparisonHome}/cmake")
