...
static void addT(
  ...
  arcTriangle0.p1 = glm::vec3(-1.0f, 1.0f, 0);
  arcTriangle0.p2 = glm::vec3(-1.9f, 1.1f, 0);
  arcTriangle0.p3 = glm::vec3(-1.8f, 1.2f, 0);
  arcTriangle0.center = glm::vec3(-1.8f, 1.2f, 0);
  arcTriangles.push_back(arcTriangle0);

  ArcQuad arcQuad0, arcQuad1;
  arcQuad0.halfArcQuad[0].p0 = glm::vec3(-1.8f, 1.2f, 0);
  arcQuad0.halfArcQuad[0].p1 = glm::vec3(+1.8f, 1.2f, 0);
  arcQuad0.halfArcQuad[0].p1 = glm::vec3(+1.8f, 1.2f, 0);
  arcQuad0.halfArcQuad[0].center = glm::vec3(0.0f, -0.0f, 0);
  ...
  arcQuad1.halfArcQuad[0].p0 = glm::vec3(-0.4f, 1.0f, 0);
  arcQuad1.halfArcQuad[0].p1 = glm::vec3( 0.4f, 1.0f, 0);
  arcQuad1.halfArcQuad[0].center = glm::vec3(0.0f, -0.0f, 0);

  arcQuad1.halfArcQuad[1].p0 = glm::vec3(-0.2f, -3.0f, 0);
  arcQuad1.halfArcQuad[1].p1 = glm::vec3(0.2f, -3.0f, 0);
  arcQuad1.halfArcQuad[1].center = glm::vec3(0.0f, -4.0f, 0);
