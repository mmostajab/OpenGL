...
SET(FrontFacingTutorialHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(FrontFacingTutorialBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "FrontFacingTutorial Source Directory: ${FrontFacingTutorialHome}")
MESSAGE(STATUS "FrontFacingTutorial Binary Directory: ${FrontFacingTutorialBinaryDir}")

# include macros
INCLUDE(${FrontFacingTutorialHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(FrontFacingTutorial_MSVC2013 TRUE)
    SET(FrontFacingTutorial_WIN32 TRUE)
...
LIST(APPEND FrontFacingTutorialIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND FrontFacingTutorialGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${FrontFacingTutorialHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND FrontFacingTutorialGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND FrontFacingTutorialGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND FrontFacingTutorialGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND FrontFacingTutorial_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${FrontFacingTutorialHome}/cmake")
