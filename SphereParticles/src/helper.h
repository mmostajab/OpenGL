...
static GLuint compile_link_vs_fs_with_source(const std::string& vertex_shader_source, const std::string& coord_sys_shader_fragment_source) {
    GLuint vertex_shader, fragment_shader;
...
static GLuint compile_link_vs_gs_fs(const std::string& vert_shader_file, const std::string& geom_shader_file, const std::string& frag_shader_file) {
  ...
  glProgramParameteriEXT(shader_program, GL_GEOMETRY_INPUT_TYPE_EXT, GL_POINTS);
  glProgramParameteriEXT(shader_program, GL_GEOMETRY_OUTPUT_TYPE_EXT, GL_TRIANGLE_STRIP);
