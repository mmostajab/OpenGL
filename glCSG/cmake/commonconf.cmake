...
SET(CSG-OpenGLHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(CSG-OpenGLBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "CSG-OpenGL Source Directory: ${CSG-OpenGLHome}")
MESSAGE(STATUS "CSG-OpenGL Binary Directory: ${CSG-OpenGLBinaryDir}")

# include macros
INCLUDE(${CSG-OpenGLHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(CSG-OpenGL_MSVC2013 TRUE)
    SET(CSG-OpenGL_WIN32 TRUE)
...
LIST(APPEND CSG-OpenGLIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND CSG-OpenGLGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${CSG-OpenGLHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND CSG-OpenGLGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND CSG-OpenGLGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND CSG-OpenGLGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND CSG-OpenGL_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${CSG-OpenGLHome}/cmake")
