...
SET(SimpleGLAppHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(SimpleGLAppBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "SimpleGLApp Source Directory: ${SimpleGLAppHome}")
MESSAGE(STATUS "SimpleGLApp Binary Directory: ${SimpleGLAppBinaryDir}")

# include macros
INCLUDE(${SimpleGLAppHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(SimpleGLApp_MSVC2013 TRUE)
    SET(SimpleGLApp_WIN32 TRUE)
...
LIST(APPEND SimpleGLAppIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND SimpleGLAppGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${SimpleGLAppHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND SimpleGLAppGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND SimpleGLAppGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND SimpleGLAppGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND SimpleGLApp_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${SimpleGLAppHome}/cmake")
