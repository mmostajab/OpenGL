...
SET(EyeDomeLightingHome ${CMAKE_CURRENT_SOURCE_DIR})
SET(EyeDomeLightingBinaryDir ${CMAKE_BINARY_DIR})
...
MESSAGE(STATUS "EyeDomeLighting Source Directory: ${EyeDomeLightingHome}")
MESSAGE(STATUS "EyeDomeLighting Binary Directory: ${EyeDomeLightingBinaryDir}")

# include macros
INCLUDE(${EyeDomeLightingHome}/cmake/macros.cmake)

# detect compiler and architecture
IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 12 2013")
    SET(EyeDomeLighting_MSVC2013 TRUE)
    SET(EyeDomeLighting_WIN32 TRUE)
...
LIST(APPEND EyeDomeLightingIncludeDirs ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}) 

LIST(APPEND EyeDomeLightingGlobalDefinitions "-DMOBIRFIDVIS_SOURCE_DIR=\"${EyeDomeLightingHome}\"")

# platform-dependent configuration
IF(WIN32)
    LIST(APPEND EyeDomeLightingGlobalDefinitions "-DNOMINMAX" "-D_CRT_SECURE_NO_DEPRECATE")
    ...
    LIST(APPEND EyeDomeLightingGlobalDefinitions /wd4290 /wd4390 /wd4503)

    # prevent error: number of sections exceeded object file format limit
    LIST(APPEND EyeDomeLightingGlobalDefinitions /bigobj)
    
    # allows 32 Bit builds to use more than 2GB RAM (VC++ only)
    SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /LARGEADDRESSAWARE")
    SET(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS} /LARGEADDRESSAWARE")
    
    LIST(APPEND EyeDomeLighting_GlobalExternalLibs netapi32 version)
ENDIF(WIN32)
...
SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${EyeDomeLightingHome}/cmake")
