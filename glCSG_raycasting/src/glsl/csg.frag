...
void main(void) {
    ...
    if (fragment_count > 1){
		...
		//if(fragment_count > 3){
		//vec4 meta_data  = unpackSnorm4x8(fragment_list[0].w);
		//if(meta_data.x < 0.0f) {
		//	vec4 frag_color = unpackUnorm4x8(fragment_list[3].y);
		//	color = frag_color;
		//	return;
		// discard;
		// }
		...
		//int layer = 4;
		//if(fragment_count > layer + 1){
		//	color =  unpackUnorm4x8(fragment_list[layer].y);
		//	return;
		//} else discard;
